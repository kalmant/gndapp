...
PacketDetailsTable {
    model: [
        ...
        TelemetryObject {
            ...
            content: String(packet.obc.activeObcTemperature_C10 / 10.0) + " °C"
        },
        TelemetryObject {
            group: "OBC"
            description: "RTCC1 temperature"
            content: String(packet.obc.rtcc1Temperature_C10 / 10.0) + " °C"
        },
        TelemetryObject {
            group: "OBC"
        ...
        TelemetryObject {
            ...
            content: String(packet.obc.comTxStatus.powerLevel)
        },
        TelemetryObject {
            group: "OBC"
        ...
        TelemetryObject {
            ...
            content: "x=" + String(packet.obc.motionSensor1.gyroscope.x)
                     + "; y=" + String(packet.obc.motionSensor1.gyroscope.y)
                     + "; z=" + String(packet.obc.motionSensor1.gyroscope.z)
        },
        TelemetryObject {
            group: "OBC"
            description: "MPU2 gyroscope"
            content: "x=" + String(packet.obc.motionSensor2.gyroscope.x)
                     + "; y=" + String(packet.obc.motionSensor2.gyroscope.y)
                     + "; z=" + String(packet.obc.motionSensor2.gyroscope.z)
        },
        TelemetryObject {
            group: "OBC"
            description: "MPU1 magnetometer"
            content: "x=" + String(packet.obc.motionSensor1.magnetometer.x)
                     + "; y=" + String(packet.obc.motionSensor1.magnetometer.y)
                     + "; z=" + String(packet.obc.motionSensor1.magnetometer.z)
        },
        TelemetryObject {
            group: "OBC"
            description: "MPU2 magnetometer"
            content: "x=" + String(packet.obc.motionSensor2.magnetometer.x)
                     + "; y=" + String(packet.obc.motionSensor2.magnetometer.y)
                     + "; z=" + String(packet.obc.motionSensor2.magnetometer.z)
        },
        TelemetryObject {
            group: "OBC"
            description: "MPU1 accelerometer"
            content: "x=" + String(packet.obc.motionSensor1.accelerometer.x)
                     + "; y=" + String(packet.obc.motionSensor1.accelerometer.y)
                     + "; z=" + String(packet.obc.motionSensor1.accelerometer.z)
        },
        TelemetryObject {
            group: "OBC"
            description: "MPU2 accelerometer"
            content: "x=" + String(packet.obc.motionSensor2.accelerometer.x)
                     + "; y=" + String(packet.obc.motionSensor2.accelerometer.y)
                     + "; z=" + String(packet.obc.motionSensor2.accelerometer.z)
        },
        TelemetryObject {
            group: "OBC"
            description: "MPU1 temperature"
            content: String(packet.obc.motionSensor1.temperature_C10 / 10.0) + " °C"
        },
        TelemetryObject {
            group: "OBC"
            description: "MPU2 temperature"
            content: String(packet.obc.motionSensor2.temperature_C10 / 10.0) + " °C"
        },
        TelemetryObject {
            group: "OBC"
        ...
        TelemetryObject {
            group: "OBC"
            description: "SPI 1"
            content: "flash: " + String(packet.obc.obcBoardStatus.flash1Status ? "OK" : "NO")
                     + " mpu: " + String(packet.obc.obcBoardStatus.motionSensor1Status ? "OK" : "NO")
                     + " rtcc: " + String(packet.obc.obcBoardStatus.rtcc1Status ? "OK" : "NO")
        },
        TelemetryObject {
            group: "OBC"
            description: "SPI 2"
            content: "flash: " + String(packet.obc.obcBoardStatus.flash2Status ? "OK" : "NO")
                     + " mpu: " + String(packet.obc.obcBoardStatus.motionSensor2Status ? "OK" : "NO")
                     + " rtcc: " + String(packet.obc.obcBoardStatus.rtcc2Status ? "OK" : "NO")
        },
        TelemetryObject {
            group: "COM"
            description: "Timestamp"
        ...
        TelemetryObject {
            group: "COM"
            description: "SPA voltage"
            content: String(packet.com.spectrumAnalyzerStatus.voltage_30mV * 30.0) + " mV"
        },
        TelemetryObject {
            group: "COM"
