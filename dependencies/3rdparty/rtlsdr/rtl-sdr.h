...
/*!
 * Returns the value of dev_lost for the device
 *
 * \param dev the device handle
 * \return 1 if the device has been lost, 0 if it has not been lost
 */
RTLSDR_API int has_device_been_lost(rtlsdr_dev_t *dev);
